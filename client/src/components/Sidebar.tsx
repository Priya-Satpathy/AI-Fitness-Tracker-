...
const Sidebar = () => {
 ...
 const navItems = [
  ...
  return (
    <nav
      className='hidden lg:flex flex-col w-64 bg-white dark:bg-slate-900 border-r
    ...
    >
      ...
      <button 
      onClick={toggleTheme} className='flex items-center gap-3 px-4 py-2.5 w-full text-slate-500
